...
const FOODS = {
  ...
  egg:             { name: "Eggs",                cal: 155, protein: 13,   carbs: 1.1,  fat: 11,   price: 0.45, veg: true, proteinFamily: "egg" },
  greek_yogurt:    { name: "Greek Yogurt",        cal: 59,  protein: 10,   carbs: 3.6,  fat: 0.4,  price: 0.60, veg: true, proteinFamily: "dairy" },
  chicken_breast:  { name: "Chicken Breast",      cal: 165, protein: 31,   carbs: 0,    fat: 3.6,  price: 0.90, veg: false, proteinFamily: "poultry" },
  ...
  salmon:          { name: "Salmon",              cal: 208, protein: 20,   carbs: 0,    fat: 13,   price: 1.80, veg: false, proteinFamily: "fish" },
  sweet_potato:    { name: "Sweet Potato",        cal: 86,  protein: 1.6,  carbs: 20,   fat: 0.1,  price: 0.25, veg: true },
  black_beans:     { name: "Black Beans (cooked)",cal: 132, protein: 8.9,  carbs: 23.7, fat: 0.5,  price: 0.20, veg: true, proteinFamily: "plant" },
  ...
  hummus:          { name: "Hummus",              cal: 166, protein: 8,    carbs: 14,   fat: 10,   price: 0.80, veg: true, proteinFamily: "plant" },
  cottage_cheese:  { name: "Cottage Cheese",      cal: 98,  protein: 11,   carbs: 3.4,  fat: 4.3,  price: 0.55, veg: true, proteinFamily: "dairy" },
  quinoa:          { name: "Quinoa (cooked)",     cal: 120, protein: 4.4,  carbs: 21.3, fat: 1.9,  price: 0.45, veg: true },
  turkey_breast:   { name: "Turkey Breast",       cal: 135, protein: 30,   carbs: 0,    fat: 1,    price: 1.10, veg: false, proteinFamily: "poultry" },
  tofu:            { name: "Tofu",                cal: 76,  protein: 8,    carbs: 1.9,  fat: 4.8,  price: 0.40, veg: true, proteinFamily: "plant" },
  lentils:         { name: "Lentils (cooked)",    cal: 116, protein: 9,    carbs: 20,   fat: 0.4,  price: 0.20, veg: true, proteinFamily: "plant" },
  bell_pepper:     { name: "Bell Pepper",         cal: 31,  protein: 1,    carbs: 6,    fat: 0.3,  price: 0.45, veg: true },
  cheddar_cheese:  { name: "Cheddar Cheese",      cal: 403, protein: 25,   carbs: 1.3,  fat: 33,   price: 1.20, veg: true, proteinFamily: "dairy" },
  pasta:           { name: "Pasta (cooked)",      cal: 131, protein: 5,    carbs: 25,   fat: 1.1,  price: 0.15, veg: true },
  ground_beef:     { name: "Lean Ground Beef",    cal: 176, protein: 20,   carbs: 0,    fat: 10,   price: 1.10, veg: false, proteinFamily: "red_meat" },
  ...
  bacon:           { name: "Bacon",               cal: 541, protein: 37,   carbs: 1.4,  fat: 42,   price: 1.30, veg: false, proteinFamily: "red_meat" },
  breakfast_sausage:{name: "Turkey Breakfast Sausage", cal: 300, protein: 14, carbs: 2, fat: 27, price: 1.10, veg: false, proteinFamily: "poultry" },
};
