...
const FOODS = {
  ...
  banana:          { name: "Banana",              protein: 1.1,  carbs: 22.8, fat: 0.3,  price: 0.11, veg: true, category: "Produce" },
  almond_milk:     { name: "Almond Milk",         protein: 0.6,  carbs: 0.6,  fat: 1.5,  price: 0.12, veg: true, category: "Dairy" },
  egg:             { name: "Eggs",                protein: 13,   carbs: 1.1,  fat: 11,   price: 0.45, veg: true, category: "Protein", proteinFamily: "egg" },
  greek_yogurt:    { name: "Greek Yogurt",        protein: 10,   carbs: 3.6,  fat: 0.4,  price: 0.31, veg: true, category: "Dairy", proteinFamily: "dairy" },
  ...
  broccoli:        { name: "Broccoli",            protein: 2.8,  carbs: 6.6,  fat: 0.4,  price: 0.46, veg: true, category: "Produce" },
  salmon:          { name: "Salmon",              protein: 20,   carbs: 0,    fat: 13,   price: 1.80, veg: false, category: "Protein", proteinFamily: "fish" },
  sweet_potato:    { name: "Sweet Potato",        protein: 1.6,  carbs: 20,   fat: 0.1,  price: 0.22, veg: true, category: "Produce" },
  ...
  spinach:         { name: "Spinach",             protein: 2.9,  carbs: 3.6,  fat: 0.4,  price: 0.67, veg: true, category: "Produce" },
  ...
  avocado:         { name: "Avocado",             protein: 2,    carbs: 8.5,  fat: 14.7, price: 0.39, veg: true, category: "Produce" },
  almonds:         { name: "Almonds",             protein: 21,   carbs: 22,   fat: 50,   price: 1.50, veg: true, category: "Pantry & Grains" },
  apple:           { name: "Apple",               protein: 0.3,  carbs: 13.8, fat: 0.2,  price: 0.29, veg: true, category: "Produce" },
  carrots:         { name: "Carrots",             protein: 0.9,  carbs: 9.6,  fat: 0.2,  price: 0.28, veg: true, category: "Produce" },
  hummus:          { name: "Hummus",              protein: 8,    carbs: 14,   fat: 10,   price: 0.80, veg: true, category: "Pantry & Grains", proteinFamily: "plant" },
  cottage_cheese:  { name: "Cottage Cheese",      protein: 11,   carbs: 3.4,  fat: 4.3,  price: 0.63, veg: true, category: "Dairy", proteinFamily: "dairy" },
  ...
  bell_pepper:     { name: "Bell Pepper",         protein: 1,    carbs: 6,    fat: 0.3,  price: 0.59, veg: true, category: "Produce" },
  ...
  ground_beef:     { name: "Lean Ground Beef",    protein: 20,   carbs: 0,    fat: 10,   price: 0.81, veg: false, category: "Protein", proteinFamily: "red_meat" },
  blueberries:     { name: "Blueberries",         protein: 0.7,  carbs: 14.5, fat: 0.3,  price: 1.72, veg: true, category: "Produce" },
  ...
  tuna:            { name: "Canned Tuna",         protein: 26,   carbs: 0,    fat: 1,    price: 0.70, veg: false, category: "Protein", proteinFamily: "fish" },
  ...
  onion:           { name: "Onion",               protein: 1.1,  carbs: 9,    fat: 0.1,  price: 0.18, veg: true, category: "Produce" },
  ...
  cauliflower:     { name: "Cauliflower",         protein: 1.9,  carbs: 5,    fat: 0.3,  price: 0.32, veg: true, category: "Produce" },
  white_rice:      { name: "White Rice (cooked)", protein: 2.7,  carbs: 28,   fat: 0.3,  price: 0.74, veg: true, category: "Pantry & Grains" },
  corn_flakes:     { name: "Corn Flakes Cereal",  protein: 7,    carbs: 84,   fat: 0.4,  price: 0.38, veg: true, category: "Pantry & Grains" },
